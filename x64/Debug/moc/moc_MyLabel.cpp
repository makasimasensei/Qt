...
QT_MOC_LITERAL(1, 8, 11), // "messageEmit"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 14), // "QList<QString>"
QT_MOC_LITERAL(4, 36, 10) // "stringList"

    },
    "MyLabel\0messageEmit\0\0QList<QString>\0"
    "stringList"
};
...
void MyLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyLabel::*)(const QList<QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLabel::messageEmit)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLabel::messageEmit(const QList<QString> & _t1)
{
